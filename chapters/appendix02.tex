...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=1\textwidth]{chapters/images/art-performance/art-all-runs-message.png}
%     \caption{Target Adapter message throughput (per run)}
%     \label{fig:appendix02:graphs:artallrunsmessage}
% \end{figure}
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=1\textwidth]{chapters/images/art-performance/art-all-runs-transaction.png}
%     \caption{Target Adapter transaction throughput scatter plot (per run)}
%     \label{fig:appendix02:graphs:artallrunstransaction}
% \end{figure}